...
latex_elements = {
    ...
    'preamble': r'''
        ...
        \fancyfoot[R]{\ifthenelse{\isodd{\value{page}}}{{\tiny EnOS 数据报表} }{\href{https://www.envisioniot.com}{\tiny Envision digital}}}
    ...
    'maketitle': r'''
        ...
        \begin{titlepage}
            ...
            \fontsize{30pt}{\baselineskip}\selectfont \textbf{数据报表}
...
latex_documents = [
    (master_doc, u'EnOSDocumentationCenter.tex', u'数据报表',
     u'远景智能', 'book', 'true'),
]
...
man_pages = [
    (master_doc, u'enosdocumentationcenter', u'EnOS Data Report',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'EnOSDocumentationCenter', 'EnOS Data Report',
...
texinfo_documents = [
    (master_doc, 'EnOSDocumentationCenter', 'EnOS Data Report',
     author, 'EnOSDocumentationCenter', 'Product documentation about EnOS Data Report.',
     'Miscellaneous'),
]
